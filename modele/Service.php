...
{
    // Design Pattern CRUD
    protected static $sqlCreate = "INSERT INTO service (id, libelle) VALUES (:id, :libelle)";
    protected static $sqlRead = "SELECT * FROM service";
    protected static $sqlUpdate = "UPDATE service SET libelle = :libelle WHERE id = :id";
    protected static $sqlDelete = "DELETE FROM service";

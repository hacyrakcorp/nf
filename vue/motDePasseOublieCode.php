<div id="connexion">
	<form method = "post" action="<?php echo $this->getServerParam('PHP_SELF') ?>?page=traitementMotDePasseOublieVerifierCode">
		...
		<div id="text">
			<input class="myInput" type="text" autocomplete="off" name="code_verif" placeholder="Code de vérification">
			<br>
			<br>
			<input class = "myButton" type="submit" name="code_verif_valider" value = "Valider">
		</div>	
	</form>
</div>
